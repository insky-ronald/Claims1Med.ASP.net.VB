...
TabularReportView.prototype.viewCss = "claim cummulative by invoice report";
TabularReportView.prototype.viewUrl = "app/report-1501";
TabularReportView.prototype.searchWidth = 600;
TabularReportView.prototype.exportName = "Claim Cummulative Report - Invoice";
...
TabularReportView.prototype.OnInitData = function(dataset) {
	...
	dataset.Columns
		...
		.setprops("invoice_received_date", {label:"Invoice Received Date", type:"date"})
		.setprops("payee_name", {label:"Payee Name"})
		.setprops("notification_date", {label:"Notification Date", type:"date"})
		...
		.setprops("excess", {label:"Excess", numeric:true, format:"00"})
		...
		.setprops("status_date", {label:"Status Date", type:"date"})
		.setprops("float_code", {label:"Float Code"})
		.setprops("float_name", {label:"Float Name"})
...
TabularReportView.prototype.OnInitColumns = function(grid) {
	...
	grid.NewColumn({fname: "area_of_loss", width: 100, allowSort: true});
	grid.NewColumn({fname: "invoice_no", width: 100, allowSort: true});
	grid.NewColumn({fname: "invoice_date", width: 100, allowSort: true});
	grid.NewColumn({fname: "invoice_received_date", width: 125, allowSort: true});
	grid.NewColumn({fname: "payee_name", width: 250, allowSort: true});
	...
	grid.NewColumn({fname: "client_currency", width: 100, allowSort: true});
	grid.NewColumn({fname: "client_amount", width: 100, allowSort: true});
	grid.NewColumn({fname: "excess", width: 75, allowSort: true});
	...
	grid.NewColumn({fname: "float_code", width: 75, allowSort: true});
	grid.NewColumn({fname: "float_name", width: 75, allowSort: true});
	grid.NewColumn({fname: "icd_code", width: 75, allowSort: true});
	grid.NewColumn({fname: "diagnosis", width: 150, allowSort: true});
};
