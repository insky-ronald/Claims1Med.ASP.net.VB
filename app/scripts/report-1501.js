...
TabularReportView.prototype.OnInitColumns = function(grid) {
	...
	grid.NewColumn({fname: "invoice_no", width: 100, allowSort: false});
	grid.NewColumn({fname: "invoice_date", width: 100, allowSort: false});
	grid.NewColumn({fname: "invoice_received_date", width: 125, allowSort: false});
	grid.NewColumn({fname: "payee_name", width: 250, allowSort: false});
	...
	grid.NewColumn({fname: "float_code", width: 75, allowSort: false});
	grid.NewColumn({fname: "float_name", width: 75, allowSort: false});
	grid.NewColumn({fname: "icd_code", width: 75, allowSort: false});
	grid.NewColumn({fname: "diagnosis", width: 150, allowSort: false});
};
