var CaseFeeStatusLookup = function(edit, grid) {
	grid.Events.OnInit.add(function(grid) {
		...
		grid.optionsData.url = "lookup?name=lookup_case_fee_status";
	});
...
var CaseFeeSubStatusLookup = function(edit, grid) {
	grid.Events.OnInit.add(function(grid) {
		grid.optionsData.cache = false;
		grid.options.horzScroll = true;
		grid.options.showPager = true;
