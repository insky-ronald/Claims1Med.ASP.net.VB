...
// ****************************************************************************************************
//==================================================================================================
// File name: pharmacies.js
//==================================================================================================
function ProviderPharmaciesView(params) {
	var pharmaciesMasterView;
	...
	new jSplitContainer($.extend(params, {
		...
		init: function(splitter) {
			splitter.events.OnPaintPane1.add(function(splitter, container) {
				pharmaciesMasterView = PharmaciesView({container: container});
			});
			...
			splitter.events.OnPaintPane2.add(function(splitter, container) {
				new jPageControl({
					...
					container: container,
					masterView: pharmaciesMasterView,
					init: function(pg) {
