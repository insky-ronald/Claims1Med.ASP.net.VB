...
// ****************************************************************************************************
//==================================================================================================
// File name: hospitals.js
//==================================================================================================
function ProviderHospitalsView(params) {
	var hospitalsMasterView;
	...
	new jSplitContainer($.extend(params, {
		...
		init: function(splitter) {
			splitter.events.OnPaintPane1.add(function(splitter, container) {
				hospitalsMasterView = HospitalsView({container: container});
			});
			...
			splitter.events.OnPaintPane2.add(function(splitter, container) {
				new jPageControl({
					...
					container: container,
					masterView: hospitalsMasterView,
					init: function(pg) {
