		...
		init: function(grid, callback) {			
			grid.Events.OnInit.add(function(grid) {
				...
				grid.Events.OnInitColumns.add(function(grid) {
						...
						grid.NewColumn({fname: "batch_name", width: 250, allowSort: false, fixedWidth:true});
						grid.NewColumn({fname: "remarks", width: 300, allowSort: false, fixedWidth:true});
				});
			});
		}
	});	
