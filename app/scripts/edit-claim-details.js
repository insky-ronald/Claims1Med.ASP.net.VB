				...
				editor.NewGroupEdit({caption:"General", icon:{name:"view-list", color:"forestgreen"}}, 
					function(editor, tab) {
						...
						editor.AddGroup("Reference Numbers", function(editor) {
							...
							if(desktop.dbMember.get("claim_reference1")) editor.AddEdit({ID: "reference_no1"});
							if(desktop.dbMember.get("claim_reference2")) editor.AddEdit({ID: "reference_no2"});
							if(desktop.dbMember.get("claim_reference3")) editor.AddEdit({ID: "reference_no3"});
						});
