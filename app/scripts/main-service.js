...
MainPage.prototype.AfterPaint = function() {
	...
	desktop.dbService.Columns
		...
		.setprops("claim_currency_code", {label:"Currency", lookupDataset: desktop.dbCurrencies,
		...
		// .setprops("provider_id", {label:"Provider", required:true, //lookupDataset: desktop.dbCountries,
			// getText: function(column, value) {
