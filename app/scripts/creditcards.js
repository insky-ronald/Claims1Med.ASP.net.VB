...
// ****************************************************************************************************
//==================================================================================================
// File name: creditcards.js
//==================================================================================================
function ProviderCreditCardsView(params) {
	var creditcardsMasterView;
	...
	new jSplitContainer($.extend(params, {
		...
		init: function(splitter) {
			splitter.events.OnPaintPane1.add(function(splitter, container) {
				creditcardsMasterView = CreditCardsView({container: container});
			});
			...
			splitter.events.OnPaintPane2.add(function(splitter, container) {
				new jPageControl({
					...
					container: container,
					masterView: creditcardsMasterView,
					init: function(pg) {
