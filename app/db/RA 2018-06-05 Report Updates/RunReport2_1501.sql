...
/****** Object:  StoredProcedure [dbo].[RunReport2_1501]    Script Date: 6/19/2018 11:11:26 AM ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [dbo].[RunReport2_1501] 
(
	@id int = 0, 
...
BEGIN
	...
	SET @source = 'v_report_raw_1501'
	SET @total_source = ''
	SET @source_join = 'id'
	SET @final_source = 'v_report_1501'
	SET @totals = ''
	SET @columns = '*'
