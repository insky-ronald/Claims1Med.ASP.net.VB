DROP PROCEDURE [dbo].[RunReport2_1005]
GO

CREATE PROCEDURE [dbo].[RunReport2_1005] 
-- ***************************************************************************************************
-- Last modified on
-- 26-SEP-2017
-- *************************************************************************************************** 
...
BEGIN
	...
	EXEC RunDynamicQueryBuilder2 @id=@id, @static_value = 'MartinaF', @type='c', @operator='=', @name='', @column_name='action_owner', @where = @where OUTPUT, @parameters = @parameters OUTPUT, @values = @values OUTPUT
