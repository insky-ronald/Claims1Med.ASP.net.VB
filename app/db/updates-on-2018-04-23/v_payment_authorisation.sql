DROP VIEW [dbo].[v_payment_authorisation] 
GO

CREATE VIEW [dbo].[v_payment_authorisation] 
AS
	SELECT
		claim_id = CLAIM_NO,
	    ...
	    authorised = cast(AUTH_READY as int),
		authorised_amount = AUTH_AMOUNT
	FROM vw_payment_authorisation
GO
